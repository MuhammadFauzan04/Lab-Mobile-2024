...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull PostAdapter.ViewHolder holder, int position) {
        ...
        Story storyModels = stories.get(position);
        ...
        holder.tvUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("story", storyModels);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvUser = itemView.findViewById(R.id.tv_uname);
            ivPost = itemView.findViewById(R.id.iv_post);
            tvUser2 = itemView.findViewById(R.id.tv_unamee);
