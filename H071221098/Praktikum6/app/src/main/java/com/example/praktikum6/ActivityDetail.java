                ...
                handler.post(() -> {
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (user != null) {
                            ...
                            Toast.makeText(ActivityDetail.this, "User not found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(ActivityDetail.this, "Failed to retrieve user data", Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    private void showErrorView() {
        ...
        retryButton.setOnClickListener(v -> {
            if (isNetworkAvailable()) {
                ...
                Toast.makeText(ActivityDetail.this, "Internet connection still unavailable", Toast.LENGTH_SHORT).show();
                handler.postDelayed(() -> {
                    errorTextView.setVisibility(View.GONE);
                    retryButton.setVisibility(View.GONE);
                    getUserDetails(userId);
