    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("faauuuzan", "Ojan", konten, R.drawable.ojannn, selectedImageUri);

                Bundle bundle = new Bundle();
                bundle.putParcelable(com.example.praktikum4.HomeFragment.EXTRA_INSTAGRAM, instagram);
